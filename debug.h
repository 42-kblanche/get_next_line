...
/*   Updated: 2025/12/08 17:44:13 by kblanche         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
#define debugs2(S1, S2) printf("%sDEBUG: %s [%s%s%s]\n%s", YELLOW, S2, NEUTRAL, S1, YELLOW, NEUTRAL)
#define debugd(DOUBLE) printf("%sDEBUG: [%s%d%s]\n%s", YELLOW, NEUTRAL, DOUBLE, YELLOW, NEUTRAL)
#define errors(STRING) printf("%sERROR: [%s%s%s]\n%s", RED, NEUTRAL, STRING, RED, NEUTRAL)
#define infos(STRING) printf("%sINFO: [%s%s%s]\n%s", MAGENTA, NEUTRAL, STRING, MAGENTA, NEUTRAL)
